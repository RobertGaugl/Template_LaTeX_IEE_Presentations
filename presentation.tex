...
\institute{Institute of Electricity Economics and Energy Innovation/TU Graz}
...
\newcommand{\urllinkedin}{linkedin.com/company/iee-tugraz} % Without https://
...
\begin{frame}{Additional Tips}
    ...
    \begin{coloredblock}[iee][\faIcon{dog}~~~Icons][\centering]
        \begin{itemize}
            \item Incorporate \textbf{icons} to enhance \textbf{visual clarity and aid }quick \textbf{comprehension}
            \item The \textbf{recommended option} in \LaTeX~is to use icons from the \textbf{fontawesome package}. You can find all \textbf{available icons} in the \href{https://mirror.easyname.at/ctan/fonts/fontawesome7/doc/fontawesome7.pdf}{\textbf{docs}}. Add an attribution on the \hyperlink{frame:closing_slide}{closing slide}.
...
\begin{frame}{Methodology}
    ...
    \begin{minipage}[t]{0.2\textwidth}
        ...
        \begin{coloredblockdark}[blue][][][][2.35cm][][0ex][0ex]
                \begin{minipage}[c][2.35cm][c]{0.4\textwidth}
                    \centering
                    \Large{\faIcon{arrows-left-right}}
                \end{minipage}%
                \hfill
                \begin{minipage}[c][2.35cm][c]{0.55\textwidth}
                    \centering
...
\begin{frame}{Decarbonization}
    ...
    \begin{columns}
        ...
        \begin{column}{0.39\textwidth}
            \begin{coloredblockicon}[grey][][][\large\faIcon{temperature-half}][l][c][3.7cm]
    ...
    \addsource{Source: \href{https://www.swp-berlin.org/en/publication/eu-climate-policy-unconventional-mitigation}{SWP Berlin}}
...
\begin{frame}{Classification}
    ...
    \begin{coloredblockicon}[green][Task][\footnotesize][\faIcon{list-check}]
        \vspace{.3cm}
        \begin{tugitemize}
...
\begin{frame}{Classification}
    ...
    \begin{columns}
        \begin{column}{0.32\textwidth}
            ...
            \begin{coloredblock}[yellow][\faIcon[regular]{face-smile-beam}~~~Sentiment Analysis][\footnotesize\centering][][6.2cm]
                \begin{itemize}
        ...
        \begin{coloredblock}[green][\faIcon{person-running}~~~Activity Recognition][\footnotesize\centering][][6.2cm]
            \begin{itemize}
