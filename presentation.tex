    ...
    \begin{columns}
        \begin{column}{0.49\textwidth}
            ...
            \begin{coloredblockdark}[yellow][Dark Yellow Block with Title]
                \footnotesize\texttt{\textbackslash begin\{coloredblockdark\}[yellow]\allowbreak [Yellow Block with Title]}\strut
            \end{coloredblockdark}
        ...
        \begin{column}{0.49\textwidth}
            ...
            \begin{coloredblockdark}[green][Dark Green Block with Title]
                \footnotesize\texttt{\textbackslash begin\{coloredblockdark\}[green]\allowbreak [Green Block with Title]}\strut
            \end{coloredblockdark}
...
\begin{frame}{Boxes}
    \framesubtitle{Boxes with Icon on the Right}

    \begin{coloredblock}[grey]
        \footnotesize\centering\texttt{\textbackslash begin\{coloredblockright\}[color][Optional:~Right Icon][Optional:~Height cm][Optional:~Left Width cm]}
    \end{coloredblock}
