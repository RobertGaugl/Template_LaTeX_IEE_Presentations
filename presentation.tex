...
\begin{frame}{Overlay}
    ...
    \begin{coloredblock}[yellow]%[][][\large\faIcon{exclamation}]
        \begin{itemize}
...
\begin{frame}{Classification}
    ...
    \begin{columns}
        \begin{column}{0.32\textwidth}
            ...
            \end{coloredblock}
            \vspace{0.3cm}
            \begin{coloredblock}[red][\faIcon{image}~~~Image Recognition][\footnotesize\centering][][5.8cm]
                    \begin{itemize}
        ...
        \end{column}
        \begin{column}{0.32\textwidth}
            \begin{coloredblock}[blue][\faIcon{stethoscope}~~~Disease Diagnosis][\footnotesize\centering][][5.8cm]
                \begin{itemize}
            ...
            \end{coloredblock}
            \vspace{0.3cm}
            \begin{coloredblock}[turquoise][\faIcon{comments}~~~Language Detection][\footnotesize\centering][][5.8cm]
                \begin{itemize}
        ...
        \begin{coloredblock}[green][\faIcon{running}~~~Activity Recognition][\footnotesize\centering][][5.8cm]
            \begin{itemize}
        ...
        \end{coloredblock}
        \vspace{0.3cm}
        \begin{coloredblock}[grey][\faIcon{envelope}~~~E-Mail Spam Detection][\footnotesize\centering][][5.8cm]
            \begin{itemize}
