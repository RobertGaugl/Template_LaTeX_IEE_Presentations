...
\begin{frame}{Boxes}
    ...
    \begin{coloredblock}[grey]
        \footnotesize\centering\texttt{\textbackslash begin\{coloredblock\}[Color][Optional:~Title][Optional:~Title~Size][Optional:~Height~cm] [Optional:~Padding~ex]}
    \end{coloredblock}
...
\begin{frame}{Boxes}
    ...
    \begin{coloredblock}[grey]
        \footnotesize\centering\texttt{\textbackslash begin\{coloredblockdark\}[Color][Optional:~Title][Optional:~Title~Size] [Optional:~Height~cm][Optional:~Padding~ex]}
    \end{coloredblock}
...
\begin{frame}{Boxes}
    \framesubtitle{Boxes with Title with Icon on the Left}

    \begin{coloredblock}[grey]
        \footnotesize\centering\texttt{\textbackslash begin\{coloredblockleft\}[Color][Optional:~Title][Optional:~Title~Size] [Optional:~Left~Icon][Optional:~Height~cm][Optional:~Left~Width~cm]}
    ...
    \begin{columns}
        \begin{column}{0.49\textwidth}
            ...
            \begin{coloredblockleft}[blue][Blue Box with Title and Left Icon][][\large\faIcon{bolt}]
                \vspace{0.2cm}
                \footnotesize\texttt{\textbackslash begin\{coloredblockleft\}[blue][Blue Box with Title and Left Icon][][\textbackslash faIcon\{bolt\}]}\strut
            \end{coloredblockleft}
    
            \begin{coloredblockleft}[yellow][Yellow Box with Title and Left Icon][][\large\faIcon{bolt}]
                \vspace{0.2cm}
                \footnotesize\texttt{\textbackslash begin\{coloredblockleft\}[yellow] [Yellow Box with Title and Left Icon][][\textbackslash faIcon\{bolt\}]}\strut
            \end{coloredblockleft}

        \end{column}
        \begin{column}{0.49\textwidth}
        
            \begin{coloredblockleft}[iee][IEE Box with Title and Left Icon][][\large\faIcon{bolt}]
                \vspace{0.2cm}
                \footnotesize\texttt{\textbackslash begin\{coloredblockleft\}[iee][IEE Box with Title and Left Icon][][\textbackslash faIcon\{bolt\}]}\strut
            \end{coloredblockleft}
    
            \begin{coloredblockleft}[green][Green Box with Title and Left Icon][][\large\faIcon{bolt}]
                \vspace{0.2cm}
                \footnotesize\texttt{\textbackslash begin\{coloredblockleft\}[green] [Green Box with Title and Left Icon][][\textbackslash faIcon\{bolt\}]}\strut
            \end{coloredblockleft}
...
\begin{frame}{Boxes}
    \framesubtitle{Boxes without Title with Icon on the Left}
...
\begin{frame}{Boxes}
    \framesubtitle{Boxes with Title with Icon on the Right}

    \begin{coloredblock}[grey]
        \footnotesize\centering\texttt{\textbackslash begin\{coloredblockright\}[Color][Optional:~Title][Optional:~Title~Size] [Optional:~Left~Icon][Optional:~Height~cm][Optional:~Left~Width~cm]}
    \end{coloredblock}
    ...
    \begin{columns}
        \begin{column}{0.49\textwidth}
            ...
            \begin{coloredblockright}[blue][Blue Box with Title and Right Icon][][\large\faIcon{bolt}]
                \vspace{0.2cm}
                \footnotesize\texttt{\textbackslash begin\{coloredblockright\}[blue][Blue Box with Title and Right Icon][][\textbackslash faIcon\{bolt\}]}\strut
            \end{coloredblockright}
    
            \begin{coloredblockright}[yellow][Yellow Box with Title and Right Icon][][\large\faIcon{bolt}]
                \vspace{0.2cm}
                \footnotesize\texttt{\textbackslash begin\{coloredblockright\}[yellow] [Yellow Box with Title and Right Icon][][\textbackslash faIcon\{bolt\}]}\strut
            \end{coloredblockright}

        \end{column}
        \begin{column}{0.49\textwidth}
        
            \begin{coloredblockright}[iee][IEE Box with Title and Right Icon][][\large\faIcon{bolt}]
                \vspace{0.2cm}
                \footnotesize\texttt{\textbackslash begin\{coloredblockright\}[iee][IEE Box with Title and Right Icon][][\textbackslash faIcon\{bolt\}]}\strut
            \end{coloredblockright}
    
            \begin{coloredblockright}[green][Green Box with Title and Right Icon][][\large\faIcon{bolt}]
                \vspace{0.2cm}
                \footnotesize\texttt{\textbackslash begin\{coloredblockright\}[green] [Green Box with Title and Right Icon][][\textbackslash faIcon\{bolt\}]}\strut
            \end{coloredblockright}
...
\begin{frame}{Boxes}
    \framesubtitle{Boxes without Title with Icon on the Right}
    ...
    \begin{columns}
        \begin{column}{0.49\textwidth}
            ...
            \begin{coloredblockright}[blue][][][\large\faIcon{bolt}][2cm][2cm]
                \vspace{0.2cm}
                \footnotesize\texttt{\textbackslash begin\{coloredblockright\}[blue]}\strut
            \end{coloredblockright}
    
            \begin{coloredblockright}[yellow][][][\large\faIcon{bolt}][2cm][2cm]
                \vspace{0.2cm}
                \footnotesize\texttt{\textbackslash begin\{coloredblockright\}[yellow]}\strut
            \end{coloredblockright}
    
            \begin{coloredblockright}[red][][][\large\faIcon{bolt}][2cm][2cm]
                \vspace{0.2cm}
                \footnotesize\texttt{\textbackslash begin\{coloredblockright\}[red]}\strut
            \end{coloredblockright}

        \end{column}
        \begin{column}{0.49\textwidth}
        
            \begin{coloredblockright}[iee][][][\large\faIcon{bolt}][2cm][2cm]
                \vspace{0.2cm}
                \footnotesize\texttt{\textbackslash begin\{coloredblockright\}[iee]}\strut
            \end{coloredblockright}
    
            \begin{coloredblockright}[green][][][\large\faIcon{bolt}][2cm][2cm]
                \vspace{0.2cm}
                \footnotesize\texttt{\textbackslash begin\{coloredblockright\}[green]}\strut
            \end{coloredblockright}
    
            \begin{coloredblockright}[grey][][][\large\faIcon{bolt}][2cm][2cm]
                \vspace{0.2cm}
                \footnotesize\texttt{\textbackslash begin\{coloredblockright\}[grey]}\strut
            \end{coloredblockright}
    ...
    \centering
    \begin{minipage}[t]{0.49\textwidth}
        \begin{coloredblockright}[turquoise][][][\large\faIcon{bolt}][2cm][2cm]
            \vspace{0.2cm}
            \footnotesize\texttt{\textbackslash begin\{coloredblockleft\}[turquoise]}\strut
        \end{coloredblockright}
...
\begin{frame}{Plots}
    ...
    \begin{table}[htbp]
        \scalebox{0.94}{
            \input{tables/power_plant_colors}
        }
    \end{table}
...
\begin{frame}{Tables}
    ...
    \begin{columns}
        ...
        \begin{column}{0.49\textwidth}
            \vspace{2cm}            
            \begin{table}[htbp]
                \input{tables/installed_capacity_2022-2025}
...
\begin{frame}{Lists}
    ...
    \begin{columns}
        \begin{column}{0.49\textwidth}
            \begin{coloredblock}[blue][\centering\texttt{\textbf{\textbackslash begin\{itemize\}}}:][\footnotesize][4.5cm]
                \begin{itemize}
                    \item Item level 1
                    \begin{itemize}
                        \item Item level 2
            ...
            \begin{coloredblock}[iee][\centering\texttt{\textbf{\textbackslash begin\{enumerate\}}}:][\footnotesize][4.5cm]
                \begin{enumerate}
                \item Item level 1
                    \begin{enumerate}
                        \item Item level 2
        ...
        \begin{column}{0.49\textwidth}
            \begin{coloredblock}[green][\centering\texttt{\textbackslash begin\{tugitemize\}} (tighter spacing):][\footnotesize][4.5cm]
                \vspace{0.5cm}
                \begin{tugitemize}
                    \item Item level 1
                    \begin{tugitemize}
            ...
            \begin{coloredblock}[grey][\centering\texttt{\textbackslash begin\{tugenumerate\}} (tighter spacing):][\footnotesize][4.5cm]
                \vspace{0.5cm}
                \begin{tugenumerate}
                    \item Item level 1
                    \begin{tugenumerate}
...
\begin{frame}{Lists}
    ...
    \begin{columns}
        \begin{column}{0.49\textwidth}
            \begin{coloredblock}[turquoise][\centering\texttt{\textbf{\textbackslash begin\{romanenumerate\}}}:][\footnotesize][4.5cm]
            ...
            \begin{coloredblock}[yellow][\centering\texttt{\textbf{\textbackslash begin\{boxenumerate\}}}:][\footnotesize][4.5cm]
                \begin{boxenumerate}
                \item Item level 1
                    \begin{boxenumerate}
                        \item Item level 2
        ...
        \end{column}
        \begin{column}{0.49\textwidth}
            \begin{coloredblock}[blue][\centering\texttt{\textbackslash begin\{tugromanenumerate\}} (tighter spacing):][\footnotesize][4.5cm]
                \vspace{0.5cm}
            ...
            \begin{coloredblock}[red][\centering\texttt{\textbackslash begin\{boxromanenumerate\}}:][\footnotesize][4.5cm]
...
\begin{frame}{Classification}
    ...
    \vspace{-0.3cm}
    \begin{coloredblockleft}[yellow][Training Data][\footnotesize][\faIcon{table}]
        \vspace{0.2cm}
        \begin{tugitemize}
    ...
    \begin{coloredblockleft}[green][Task][\footnotesize][\faIcon{tasks}]
        \vspace{0.2cm}
        \begin{tugitemize}
    ...
    \begin{coloredblockleft}[blue][Goal][\footnotesize][\faIcon{bullseye}]
        \vspace{0.2cm}
        \begin{tugitemize}
