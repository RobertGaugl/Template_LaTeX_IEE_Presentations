...
\begin{frame}{Additional Tips}
    ...
    \begin{coloredblock}[iee][\centering\faIcon{dog}~~~Icon]
        \begin{itemize}
            ...
            \item The \textbf{recommended option} in \LaTeX~is to use icons from the \textbf{awesomefont package}. You can find all \textbf{available icons} in the \href{https://mirror.easyname.at/ctan/fonts/fontawesome5/doc/fontawesome5.pdf}{\textbf{docs}}. Add an attribution on the final slide.
...
\begin{frame}
    ...
    \addsource{Icons from \textbf{Font Awesome} (\url{https://fontawesome.com}), licensed under \href{https://creativecommons.org/licenses/by/4.0/}{CC BY 4.0}.}
\end{frame}
